    ...
    try {
      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantsList = details.participants
          .map(participant => `<li><span class="participant-email">${participant}</span><button class="delete-btn" data-participant="${participant}" data-activity="${name}" aria-label="Remove ${participant}">✕</button></li>`)
          .join("");
